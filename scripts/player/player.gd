...
func _physics_process(delta: float) -> void:
	...
	# Position sync: MultiplayerSynchronizer on this scene replicates position
	# from the authority. Remote movement looks slightly late — prediction /
	# reconciliation are out of scope for this workshop (future topic).
